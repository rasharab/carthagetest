...
///
/// \param iso8601String String to parse NSDateComponents from, in ISO-8601 format.
///
/// \returns  A properly initialized NSDateComponents instance, if passed in String is valid. nil otherwise.
- (nullable instancetype)initWithIso8601String:(NSString * _Nonnull)iso8601String;
@end

@class NSCharacterSet;

@interface NSScanner (SWIFT_EXTENSION(SwiftUtils))
